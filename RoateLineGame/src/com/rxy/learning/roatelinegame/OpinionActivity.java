...
public class OpinionActivity extends Activity {
		...
		textView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if (editText.getText().toString().trim().equals("")) {
					Toast.makeText(OpinionActivity.this, "请输入内容",
	...
	private void submitOpinion(String opinion) {
		...
		volley_post(FEED_BACK_ADDRESS,getInfo(),opinion,time);
	}
	...
	public void volley_post(String url, final String user,
			final String details, final String time) {
		StringRequest sr = new StringRequest(Method.POST, url,
				new Listener<String>() {

					@Override
					public void onResponse(String arg0) {
						Toast.makeText(OpinionActivity.this, "感谢您宝贵的意见",
								Toast.LENGTH_SHORT).show();
						finish();
